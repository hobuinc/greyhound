...
public:
    ...
    std::map<uint64_t, const std::vector<uint8_t>*> errs();

private:
    std::map<uint64_t, const std::vector<uint8_t>*> m_errs;
};
...
public:
    ...
    std::map<uint64_t, const std::vector<uint8_t>*> responses();

private:
    std::map<uint64_t, const std::vector<uint8_t>*> m_data;

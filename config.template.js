...
config.cn = {
    ...
    http: {
        ...
        // 8081. This is not necessarily a public-facing port if a front-end
        // proxy is used - haproxy will route to this port for HTTP requests.
        //
    ...
    ws: {
        ...
        // Specify a port on which to listen.  If omitted or null, default is
        // 8082. This is not necessarily a public-facing port if a front-end
        // proxy is used - haproxy will route to this port for websocket
        // connections.
        //
        // IMPORTANT: If a frontend proxy is used, this value must match the
        // "backend ws" port specified in frontend-proxy/haproxy.cfg.
        port: 8082,
    },
